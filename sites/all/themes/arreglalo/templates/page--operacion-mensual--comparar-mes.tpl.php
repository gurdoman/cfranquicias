...
(function($){
    ...
    var drawChartComparativo = function (objeto, contenedor) {   
        ...
        do{
            if(objeto[x]){
                if(anio1 == 0)
                    anio1 = objeto[x].anio1;
                if(anio2 == 0)
                    anio2 = objeto[x].anio2;
            }
            x++;
            if(x>300)break;
            
        }while((anio1 == 0) || (anio2 == 0));

        var data = [['Unidad', anio1.toString(), anio2.toString(), 'Diferencia']];
        ...
        for (var key in objeto) {
            if (objeto.hasOwnProperty(key)) {
                ...
                data.push([objeto[key].unidad, parseFloat(objeto[key].vn1),parseFloat(objeto[key].vn2),diferencia]);
            }
        }
    ...
    var drawChartComparativo2 = function (objeto, contenedor) {   
        ...
        for (var key in objeto) {
            if (objeto.hasOwnProperty(key)) {
                ...
                diferencia = diferencia<0?(diferencia*-1):diferencia;
                data.push([objeto[key].unidad, parseFloat(objeto[key].vb1),parseFloat(objeto[key].vb2),diferencia]);
            }
        }
    ...
    $(document).ready(function(){
        ...
        drawChartComparativo(compararList, "chartComparativo");
        drawChartComparativo2(compararList, "chartComparativo2");
